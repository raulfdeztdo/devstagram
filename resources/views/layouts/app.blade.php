...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-100">
        ...
        <header class="p-5 bg-white border-b shadow">
            <div class="container flex items-center justify-between gap-2 mx-auto">
                <a href="{{ route('home') }}">
                    <h1 class="text-3xl font-black">DevStagram</h1>
                </a>
                @auth
                    <nav class="flex items-center gap-2 md:gap-4">
                        <a href="{{ route('posts.create') }}" class="flex items-center gap-2 p-2 font-bold text-gray-600 uppercase bg-white border cursor-pointer">
